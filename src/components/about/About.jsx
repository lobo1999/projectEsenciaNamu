                ...
                <div className="aboutUs__main">
                    <div className="flex--center aboutUs__main_proyect">
                        <p>Namú proviene de la lengua Bribrí y su significado es Jaguar,
                            ...
                            información general de estos lugares y mostrando fotografías de la mano de <Link to="/photographers">nuestro equipo
                            fotográfico</Link>.
                        </p>    
                    </div>
                ...
                <div className="cotainer--90 wkgp">
                    <div className="wkgroup__card text--center glass">
                        <div className="card__content">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime, at.</p>
                    ...
                    <div className="wkgroup__card text--center glass">
                        <div className="card__content">
                            ...
                            <a href="https://www.linkedin.com/in/manuel-ulate-sancho-481311174/" className="linkedin_a"><i className="fa-brands fa-linkedin"></i></a>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime, at.</p>
